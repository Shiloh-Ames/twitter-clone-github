...
import { Tweet, TweetBody } from '../sanity/typings'
...
function Tweetbox({setTweets}: Props) {
  ...
  return (
    <div className='flex space-x-2 p-5'>
        ...
        // This src takes the users twitter pfp or replaces it with a deafault pfp
        ...
        <div className='flex flex-1 items-center pl-2'>
            <form className='flex flex-1 flex-col'>
                ...
                <div className='flex items-center'>
                    ...
                    disabled={!input || !session} className='bg-twitter rounded-full px-5 py-2 font-bold text-white disabled:opacity-40'>
                        Tweet
                    </button>
                </div>
                {imageUrlBoxIsOpen && (
